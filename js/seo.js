(() => {
  ...
  const SERVICE_IMAGE = `${BASE}/assets/images/pinewood-services-room.jpg`;
  ...
  const routes = {
    ...
    '/dich-vu': { lang:'vi', indexable:true, title:'Dịch vụ khách sạn tại Đà Lạt | Pinewood Hotel Dalat', description:'Khám phá dịch vụ tại Pinewood Hotel Dalat: Wi-Fi miễn phí, bữa sáng 06:30–09:00, nhà hàng, café, buồng phòng và hỗ trợ Lễ tân.', image:SERVICE_IMAGE, canonical:'/dich-vu/', vi:'/dich-vu/', en:'/en/services/' },
    '/en/services': { lang:'en', indexable:true, title:'Hotel Services in Da Lat | Pinewood Hotel Dalat', description:'Explore services at Pinewood Hotel Dalat including complimentary Wi-Fi, breakfast 06:30–09:00, restaurant and café service, housekeeping and Reception support.', image:SERVICE_IMAGE, canonical:'/en/services/', vi:'/dich-vu/', en:'/en/services/' },
